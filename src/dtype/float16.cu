...
public:
    __device__ __forceinline__ HalfPrecisionFusionFloat operator*(const HalfPrecisionFusionFloat& a) const {
...
public:
    __device__ __forceinline__ Half2PrecisionFusionFloat operator*(const Half2PrecisionFusionFloat& a) const {
